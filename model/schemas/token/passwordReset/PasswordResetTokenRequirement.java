...
/**
 * Requirement wrapper for creating {@link PasswordResetTokenSchema} instances.
 * <p>
 * Holds raw mapping data and enforces that only the authorized
 * {@link PasswordResetTokenFactory} can consume it.
 * </p>
 * <p>
 ...
 * </p>
 */
public final class PasswordResetTokenRequirement extends AbstractTokenRequirement<PasswordResetTokenFactory> {
     ...
     * @param target  the only {@link PasswordResetTokenFactory} authorized to
     *                consume this requirement
     */
    private PasswordResetTokenRequirement(IMap mapping, PasswordResetTokenFactory target) {
        super(mapping, target);
    }

    /**
     * Starts the Step Builder for creating a {@link PasswordResetTokenRequirement}.
     *
    ...
    public interface TargetStage {
         ...
         *
         * @param target the {@link PasswordResetTokenFactory}, must not be null
         * @return the final stage ({@link FinalStage}) for building the requirement
         */
        FinalStage withTarget(PasswordResetTokenFactory target);
    }
    ...
    public interface FinalStage {
        ...
        /**
         * Builds the {@link PasswordResetTokenRequirement} instance with the provided
         * mapping and factory.
         *
         * @return the constructed {@link PasswordResetTokenRequirement}
         */
        PasswordResetTokenRequirement build();
    }
     ...
     * {@link PasswordResetTokenRequirement}.
     */
    private static class Builder implements MappingStage, TargetStage, FinalStage {
         ...
         */
        private PasswordResetTokenFactory target;
         ...
         */
        @Override
        public FinalStage withTarget(PasswordResetTokenFactory target) {
            this.target = Objects.requireNonNull(target, "Target factory cannot be null");
            return this;
        }

        /**
         * Builds the {@link PasswordResetTokenRequirement} instance with the previously
         * set mapping and target.
         *
         * @return the fully constructed {@link PasswordResetTokenRequirement}
         */
        @Override
        public PasswordResetTokenRequirement build() {
            return new PasswordResetTokenRequirement(mapping, target);
        }
    }
}
