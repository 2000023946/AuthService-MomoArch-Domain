...
/**
 * Requirement wrapper for creating {@link AccessTokenSchema} instances.
 * <p>
 * Holds raw mapping data and enforces that only the authorized
 * {@link AccessTokenFactory} can consume it.
 * </p>
 * <p>
 ...
 * </p>
 */
public final class AccessTokenRequirement extends AbstractTokenRequirement<AccessTokenFactory> {
     ...
     * @param target  the only {@link AccessTokenFactory} authorized to consume this
     *                requirement
     */
    private AccessTokenRequirement(IMap mapping, AccessTokenFactory target) {
        super(mapping, target);
    }

    /**
     * Starts the Step Builder for creating an {@link AccessTokenRequirement}.
     *
    ...
    public interface TargetStage {
         ...
         *
         * @param target the {@link AccessTokenFactory}, must not be null
         * @return the final stage ({@link FinalStage}) for building the requirement
         */
        FinalStage withTarget(AccessTokenFactory target);
    }
    ...
    public interface FinalStage {
        ...
        /**
         * Builds the {@link AccessTokenRequirement} instance with the provided mapping
         * and factory.
         *
         * @return the constructed {@link AccessTokenRequirement}
         */
        AccessTokenRequirement build();
    }
    ...
    private static class Builder implements MappingStage, TargetStage, FinalStage {
         ...
         */
        private AccessTokenFactory target;
         ...
         */
        @Override
        public FinalStage withTarget(AccessTokenFactory target) {
            this.target = Objects.requireNonNull(target, "Target factory cannot be null");
            return this;
        }

        /**
         * Builds the {@link AccessTokenRequirement} instance with the previously set
         * mapping and target.
         *
         * @return the fully constructed {@link AccessTokenRequirement}
         */
        @Override
        public AccessTokenRequirement build() {
            return new AccessTokenRequirement(mapping, target);
        }
    }
}
